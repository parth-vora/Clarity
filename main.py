...
class InsecuritiesHandler(webapp2.RequestHandler):
    def get(self):
        ...
        "I have less fun when I'm alone",
        "I like to share my thoughts",
        "I like to be close to the center of attention",
        "I do not tend to keep to myself in parties",
        "I like to attend social events where I am involved in the festivities",
        "I feel as if I have an easy time making new friends",
=======
...
>>>>>>> 46766f72b872ed2cb5a739746356003eed0cd08d
        ]
        template_vars={
